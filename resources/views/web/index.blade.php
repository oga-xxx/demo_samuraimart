...
<div class="row">
  ...
  <div class="col-9">
    ...
    <div class="row">
      <div class="col-4">
        <a href="#">
          <img src="{{ asset('img/chestnut.jpg') }}" class="img-thumbnail" alt="">
        </a>
        <div class="row">
          <div class="col-12">
      ...
      <div class="col-4">
        <a href="#">
          <img src="{{ asset('img/persimmon.jpg') }}" class="img-thumbnail" alt="">
        </a>
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2">
      ...
      <div class="col-4">
        <a href="#">
          <img src="{{ asset('img/orange.jpg') }}" class="img-thumbnail" alt="">
        </a>
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2">
